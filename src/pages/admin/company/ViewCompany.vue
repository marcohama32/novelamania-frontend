<template>
  <div>
    <h2 class="intro-y text-lg font-medium mt-10">Company List</h2>
        ...
        <table class="table table-report -mt-2">
          <thead>
            <tr>
              ...
              <th class="whitespace-nowrap">Plans</th>
          ...
          <tbody>
            <tr v-for="company in companies" :key="company._id" class="intro-x">
              <td class="w-40 !py-4">
                <a
                  href="#"
              ...
              <td>
                <div class="whitespace-nowrap">{{ company.plans }}</div>
                
              </td>
              <td class="w-40 text-right">
                <div class="pr-16">{{ company.contacts }}</div>
              </td>
              <td class="table-report__action">
                <div class="flex justify-center items-center">
                  ...
                  >
                    ...
                    <router-link :to="`/companymembers/${company._id}`">Members</router-link>
                  </a>
                  <a

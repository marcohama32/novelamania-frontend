        ...
        <div class="intro-y flex items-center mt-8">
         ...
         <div class="intro-y box flex flex-col lg:flex-row mt-5">
                    <div class="intro-y flex-1 px-5 py-16">
                        ...
                        <button type="button" class="btn btn-rounded-secondary py-3 px-4 block mx-auto mt-8">Update</button>
                        <button type="button" class="btn btn-rounded-primary py-3 px-4 block mx-auto mt-8">Plan Services</button>
                    </div>
